...
const AboutPage = () => {
  ...
  return (
    <div>
      ...
      <div className="md:mt-[4%] md:flex md:flex-row">
        ...
        <div className="ml-[20%] flex flex-col mt-[24px] md:ml-[11%] md:mr-[8%] md:mt-[40x] md:w-4/5 md:justify-start">
          ...
          <div className="flex flex-row md:justify-between md:items-start md:gap-36 md:inline-flex">
            <p className="font-poppins w-72 text-xs tracking-tight md:tracking-wide md:w-96 md:text-base md:font-normal h-fit">Blueprint is a multinational community with chapters run by students from different universities. As the third established chapter in Canada, our team is based at <span>
                <a href="https://www.sfu.ca"className="underline font-poppins w-72 text-xs tracking-tight md:tracking-wide md:w-96 md:text-base md:font-normal">Simon Fraser University.</a>
              </span>
            </p>
            <div className="md:justify-start md:items-start inline-flex">
              ...
              <p className="pl-10 hidden md:block font-sketch text-xl w-36 leading-none tracking-tight h-fit">A design sprint is the best way to get ideas flowing</p>
          ...
          <p className="font-poppins underline text-xs font-bold mt-4 md:mt-6 md:text-base h-fit">See all Blueprint chapters here</p>
        </div>
      ...
      <div className="mt-15 flex flex-col items-center md:hidden">
