...
const MobileGearSection = () => {
    return (
        <div className="gear-section">
            ...
            <div className="mobile-value-body">Our community foster continuous learning to support academic, social, and personal growth. We strive to offer a helping hand and push each other to succeed.</div>
            <div className="mobile-value-title">CHERISH EACH OTHER</div>
            <div className="mobile-value-body">We value individuals and appreciate our differences. Our time spent together build us meaningful relationships that extend beyond the scope of the organization.</div>
            <div className="mobile-value-title">ALWAYS INNOVATE</div>
            <div className="mobile-value-body">We are committed to innovate and emphasize effective solutions to remain relevant - nothing is sacred. No idea is off-limits, and diverse thinking is always encouraged.</div>
