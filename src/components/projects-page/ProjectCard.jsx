...
const ProjectCard = ({ project, className }) => {
  ...
  return (
    <div
      className={`${className} shadow-md w-70 min-h-full lg:min-w-[235px] bg-white`}
    >
      <img
      ...
      <div className="px-[5%] pb-3 bg-white">
        ...
        <ParagraphTitle className="text-[1.25rem] bg-white">
          {t(`projects.${project}.name`)} →{" "}
        </ParagraphTitle>
        <ParagraphText className="md:text-sm bg-white">
